...
module.exports = function(req, res){
  ...
  if (!("action" in req.body))
    ...
    try {
      ...
      var extraBalance = huc.getBalance(extraBalanceAddr);
      extraBalance = hucUnits.toHuc(extraBalance, 'wei');
    ...
    ctFind.exec(function (err, docs) {
      if (!docs.length){
        ...
        var formatDocs = docs.map( function(doc) {
          var d = doc;
          d.amount = hucUnits.toHuc(d.amount, 'wei')*100;
          return d;
        });
